 ...
 * @author Belen
 */
public class frminfractor extends javax.swing.JInternalFrame {
    ...
    void inhabilitar() {
        ...
        txtplaca_vehiculo.setEnabled(false);
        //Botones
    ...
    void habilitar() {
        ...
        txtplaca_vehiculo.setEnabled(true);
        //Botones
    ...
    void mostrar(String buscar){
        try {
            //Instancio a su funcion mostrar de FunInfractor
            DefaultTableModel modelo;
            FunInfractor func = new FunInfractor();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Registro de Infractores", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
        ...
        txtplaca_vehiculo.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtplaca_vehiculo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtplaca_vehiculoActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cbtipo_documento, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtplaca_vehiculo, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(3, 3, 3)
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Listado de Infractores", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (txtnombre.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Debe ingresar el nombre del infractor");
            txtnombre.requestFocus();
            return;
        }
        if (txtapellido.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Debe ingresar el apellido del infractor");
            txtapellido.requestFocus();
            return;
        }
        if (txtnum_documento.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Debe ingresar un tipo de documento");
            txtnum_documento.requestFocus();
            return;
        }
        if (txtplaca_vehiculo.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Debe ingresar la placa de vehículo del infractor");
            txtplaca_vehiculo.requestFocus();
            return;
        }
        
        if (txtdireccion.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Debe ingresar la dirección del infractor");
        ...
        if (txtemail.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Debe ingresar el e-mail del infractor");
        ...
        dts.setPlaca_vehiculo(txtplaca_vehiculo.getText());

        //Guardar o Editar registro
        if (accion.equals("guardar")) {
            //Inserto los datos
            if (func.insertar(dts)) {
                JOptionPane.showMessageDialog(rootPane, "Se registro al Infractor exitosamente");
            ...
            if(func.editar(dts)){
                JOptionPane.showMessageDialog(rootPane, "Se edito al Infractor exitosamente");
                //muestro todos los datos
                mostrar("");
                inhabilitar();
            }
    ...
    private void tablalistadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMouseClicked
        ...
        txtplaca_vehiculo.setText(tablalistado.getValueAt(fila, 8).toString());
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        if (!txtidpersona.getText().equals("")) {
            int confirmacion = JOptionPane.showConfirmDialog(rootPane, "Esta seguro de eliminar al Infractor?","Confirmar",2);
            if(confirmacion == 0){
                Infractor dts = new Infractor();
                FunInfractor func = new FunInfractor();
    ...
    private void txtplaca_vehiculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtplaca_vehiculoActionPerformed
        // TODO add your handling code here:
        txtplaca_vehiculo.transferFocus();
    }//GEN-LAST:event_txtplaca_vehiculoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frminfractor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frminfractor().setVisible(true);
            }
        });
    }
